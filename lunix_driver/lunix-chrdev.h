...
struct lunix_chrdev_state_struct {
	enum lunix_msr_enum type; // is defined in lunix.h
	struct lunix_sensor_struct *sensor; //is defined in lunix.h
...
#define RAW _IO(LUNIX_IOC_MAGIC, 1)
#define COOKED _IO(LUNIX_IOC_MAGIC, 0)
